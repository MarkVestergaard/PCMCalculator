...
5. Calculating velocity, cross-sectional area, and flow in the ROIs for each frame
...
`PCMCalculator` provides a freely available, open-source, and easy-to-use software tool for the analysis of 2D phase-contrast MRI data and quantification of blood flow. It is hoped that `PCMCalculator` will serve as a valuable and accessible tool for the wider MRI research and clinical community.
